...
This a the beginning repository for a tutorial adding vertical tabs in React Admin.
...
After cloning the repository, run `yarn install` to download dependencies. Then start the app with `yarn start`.
